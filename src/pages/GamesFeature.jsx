  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 right-20 w-96 h-96 bg-green-400/20 dark:bg-green-500/10 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-20 left-20 w-80 h-80 bg-emerald-400/20 dark:bg-emerald-500/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-6">
        ...
        >
          ...
          <p className="text-4xl md:text-5xl text-slate-600 dark:text-slate-300 mb-4">
            Play, Complete, and Track Your Gaming Journey
          </p>
          <motion.button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          >
            ...
            <div className="space-y-4">
              {[
                { label: 'Completed', value: stats.completed, total: stats.totalGames, color: 'bg-green-500' },
                { label: 'Playing', value: stats.playing, total: stats.totalGames, color: 'bg-blue-500' },
